...
from .views import (
   ...
   LinkTitleView, CommentListView, CommentDeleteView,
   MyProjectsView, LikedProjectView, CommentedProjectView, LikeProjectView, 
)
...
urlpatterns = [
    ...
    path('<int:project_id>/comments/',CommentListView.as_view(), name='create-read-comments'), # 댓글(및 답글) 작성
