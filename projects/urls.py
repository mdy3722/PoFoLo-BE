...
urlpatterns = [
    ...
    path('users/projects/liked/', LikedProjectView.as_view(), name='liked-projects'),
    path('users/projects/commented/', CommentedProjectView.as_view(), name='commented-projects'),
